...
openerp.date_range = function(instance) {
    ...
    instance.date_range.search_filters = instance.web.search.ExtendedSearchProposition.extend({
...
instance.web.search.ExtendedSearchProposition.DateRange = instance.web.search.ExtendedSearchProposition.Field.extend({
    ...
    on_range_selected: function(e){
        var self = this;
        self.domain = '';
        instance.web.framework.blockUI();
        ...
        .then(function (domain) {
            instance.web.framework.unblockUI();
            self.domain = domain;
        });
    },
...
instance.web.search.custom_filters.add('search_filters', 'instance.date_range.search_filters');
}
