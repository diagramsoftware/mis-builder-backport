...
class AccountingExpressionProcessor(object):
    ...
    def __init__(self, companies, currency=None):
        ...
        self.dp = self.currency.rounding
    ...
    def get_aml_domain_for_dates(self, date_from, date_to,
        ...
        if mode == self.MODE_VARIATION:
            ...
            domain = ['|',
                      ...
                      ('account_id.user_type.include_initial_balance', '=', True)]
            ...
            domain = [('date', '<', fields.Date.to_string(fy_date_from)),
                      ('account_id.user_type.include_initial_balance', '=', False)]
    ...
    def _get_company_rates(self, date):
        ...
        for company in self.companies:
            ...
            company_rates[company.id] = \
                (rate, company.currency_id.accuracy)
